...
\begin{tabular}{lrrrrr}
\toprule
Model or fixed panel & $n$ & Root & Mapped & Difference & Map control \\
\midrule
Qwen2.5-3B, two new blocks & 384 & 59.4 & 66.7 & \textbf{+7.3} & +30.3 \\
Qwen2.5-7B, original + new & 384 & 84.4 & 84.9 & +0.5 & +39.6 \\
Gemma-2-2B, new block & 192 & 75.5 & 75.0 & -0.5 & +32.6 \\
Phi-3.5-mini, new block & 192 & 79.2 & 81.8 & +2.6 & +37.7 \\
Mistral-7B, new block & 192 & 69.3 & 78.6 & \textbf{+9.4} & +35.8 \\
Three-model fixed average & 192 & 74.7 & 78.5 & \textbf{+3.8} & +35.4 \\
\bottomrule
\end{tabular}
\end{table}
