...
\name{\shortstack[c]{Yujie Shen$^{1}$ \qquad Haowen Chen$^{2*}$\\[2pt]
Yupeng Hu$^{2}$ \qquad Yuan Lei$^{1}$ \qquad Lu Fang$^{3}$}}
\address{$^{1}$School of Mathematics, Hunan University, Changsha, 410082, China\\
$^{2}$College of Computer Science and Electronic Engineering,\\
\hspace*{1.2em}Hunan University, Changsha, 410082, China\\
